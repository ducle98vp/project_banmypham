					...
					<div class="col-md-5 col-sm-5 col-xs-12">
						<div class="zoomWrapper">
							<div id="img-1" class="zoomWrapper single-zoom">
								<a href="#">
									<img id="zoom1" src="../backend/assets/uploads/<?php echo $product['avatar'] ?>" data-zoom-image="../backend/assets/uploads/<?php echo $product['avatar'] ?>" alt="big-1">
								</a>
							</div>
						...
						<div class="product-list-wrapper">
							<div class="single-product">
								<div class="product-content">
									<h2 class="product-name"><a href="#"><?php echo $product["title"]; ?></a></h2>
